 ...
 */
public class TP_SP_Bidirectional_Advance_2 {
    /**
...
//        final ConcurrentMap<Integer, ConcurrentMap<Integer, CostVector>> M = new ConcurrentHashMap<Integer, ConcurrentMap<Integer, CostVector>>();
        final ConcurrentMap<Integer, Map<Integer, CostVector>> M = new ConcurrentHashMap<Integer, Map<Integer, CostVector>>();
        ...
        Thread backward_thread = new Thread() {
            public void run() {
                ...
                Map<Integer, CostVector> cost_vectors_for_settled_node;
                ...
                while (!Q.isEmpty() && !forward_thread_status.isCompleted()) {
                    for (final Integer settled_node_id : Q) {
                        ...
                        for (Integer in_edge_index : G.get_node(settled_node_id).getIn_edges()) {
                            ...
                            cost_vectors_for_settled_node = new HashMap<Integer, CostVector>();
