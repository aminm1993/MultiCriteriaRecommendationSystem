 ...
 */
public class TP_SP_Bidirectional_Advance_3 {
    /**
    ...
    public static boolean find_optimal_route(final Graph G, final Time_Slots_of_Day time_slots_of_day, final int s,
        ...
        Thread backward_thread = new Thread() {
            public void run() {
                ...
                CostVector[] cost_vectors_for_settled_node;
                int level = 0;
                while (!Q.isEmpty() && !forward_thread_status.isCompleted() && level < 10) {
                    for (final Integer settled_node_id : Q) {
                        ...
                        for (Integer in_edge_index : G.get_node(settled_node_id).getIn_edges()) {
                            ...
                            cost_vectors_for_settled_node = new CostVector[time_slots_of_day.get_slots_number()];
