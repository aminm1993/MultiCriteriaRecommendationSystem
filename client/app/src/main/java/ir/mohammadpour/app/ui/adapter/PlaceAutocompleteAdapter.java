...
public class PlaceAutocompleteAdapter
        ...
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    ...
                    CharSequence temp=_cityname+","+constraint;
                    mResultList = getAutocomplete(temp);
                    Log.v("cityname",_cityname);
                    Log.v("cityname2",temp.toString());
                    if (mResultList != null) {
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            Log.v("autoresult",status.toString());
            if (!status.isSuccess()) {
...
//
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            Typeface type = Typeface.createFromAsset(getContext().getAssets(), "IRANSans.ttf");
            tvPlaceDescription.setTypeface(type);
            try {
