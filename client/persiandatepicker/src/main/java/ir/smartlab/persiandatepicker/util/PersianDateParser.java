...
/**
 * Parses customGray from the beginning of the given string to produce a
 * PersianCalendar.
 * 
 * <p>
...
public class PersianDateParser {
	 ...
	 * if couldn't parse the customGray.
	 * 
	...
	/**
	 * planned for further calculation before parsing the customGray
	 * 
	 * @param dateString
	 * @return
	 */
