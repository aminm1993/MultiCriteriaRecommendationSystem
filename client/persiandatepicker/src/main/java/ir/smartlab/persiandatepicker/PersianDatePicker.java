...
public class PersianDatePicker extends LinearLayout {
    ...
    public PersianDatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        setNumberPickerTextColor(yearNumberPicker,Color.parseColor("#019285"));
        setNumberPickerTextColor(monthNumberPicker,Color.parseColor("#019285"));
        setNumberPickerTextColor(dayNumberPicker,Color.parseColor("#019285"));
    }
